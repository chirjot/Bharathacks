...
class register extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener,LocationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        passw=(EditText)findViewById(R.id.passregister);
        ...
        dref = FirebaseDatabase.getInstance().getReference().child("Police");


        btn=(Button)findViewById(R.id.loginregister);
        passw = (EditText)findViewById(R.id.passregister);
        ...
        mAuth.createUserWithEmailAndPassword(use,pas).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    dref2.child("Latitude").setValue((latitide));
                    dref2.child("Longitude").setValue((longitude));
                    Intent intent=new Intent(register.this,Main2Activity.class);
                    startActivity(intent);
                    intent.putExtra("latitute",latitide);
